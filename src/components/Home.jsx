                            ...
                            <div className="h-full w-full  flex flex-col relative space-y-6">
                                <div className="mt-auto mb-0 text-gray-50 md:pb-36 space-y-6">
                                    ...
                                    <p className="max-w-[30rem] font-light ml-4 before:content-[''] relative before:absolute before:w-px before:h-full before:left-0 before:top-0 before:-translate-x-4 before:bg-accent-500 md:text-base text-sm">
                                        ...
                                        about building web and mobile
                                        applications. With a strong background
                                        in JavaScript and experience in various
                                        frameworks and libraries, I strive to
                                    ...
                                    <div className="md:flex-row flex-col flex gap-4 ml-4">
                                        <button
                                            ...
                                            className="inline-block text-base font-medium px-12 py-2 border border-accent-400 rounded-lg text-accent-400 cursor-pointer bg-gray-50/10 backdrop-blur-3xl uppercase"
                                        >
